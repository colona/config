...
if has('autocmd')
  aug filecreations
    " vim files
    au BufNewFile *.vim   call Add_Header('conf_header.tpl', '"')

    " conf files
    au BufNewFile *.conf  call Add_Header('conf_header.tpl', '#')

    " main.c
    "au BufNewFile main.c  call Add_Body('main_c.tpl')
    ...
    " Makefile
    au BufNewFile [Mm]akefile call Add_Templates('epita_header.tpl makefile.tpl', '#')

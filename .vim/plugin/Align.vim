...
"     19 : Nov 21, 2002 : BugFix: some terms gave an "unable to highlight"
...
"  call Decho("AlignCtrl() {")
  ...
  " clear insofar as Align() is concerned visual-block selection
  if g:loaded_align >= 6
   exe "silent! norm! v\<Esc>"
  else
   let g:loaded_align= g:loaded_align + 1
  endif
